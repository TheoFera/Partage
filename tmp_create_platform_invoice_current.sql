...
begin
  ...
  -- Validation stricte: chaque lot utilise doit avoir exactement une ligne platform.
  ...
  if exists (
    ...
    platform_rows as (
      ...
      select lpb.lot_id, count(*) as cnt
    ...
    raise exception
      ...
      'Commission plateforme impossible: il doit y avoir exactement 1 ligne platform par lot utilise (order_id=%).',
